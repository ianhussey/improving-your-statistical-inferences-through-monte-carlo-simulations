...
<!-- TODO: improve tidy section -->
<!-- TODO: add the "is this data normal?" exercise to this lesson or as a recap; remind people about the difference between sample and population, and that simulated data gives you access to the ground truth. -->
<!-- TODO: standardize use of set.seed above -->
<!-- TODO: add note on Concept of DGP: If you sample the entire population, you still need inferential stats to understand the DGP. Eg if you study astronauts, and there are only 12 of them, and you recruit all of them, you don't automatically know the DGP, which is an abstraction, involves error, etc -->
<!-- TODO: Other distributions to add? -->
<!-- TODO: - Skew normal data -->
<!-- TODO: - Uniform data -->
<!-- TODO: - Likert data? (?other than truffle) -->
<!-- TODO: - mixed cor and factor data -->
<!-- TODO: - Item level data? (lavaan) -->
...
Ready to practice? 
Download and complete the [exercises for this chapter](../exercises/04_data_generating_process_functions_exercises.qmd).
:::
