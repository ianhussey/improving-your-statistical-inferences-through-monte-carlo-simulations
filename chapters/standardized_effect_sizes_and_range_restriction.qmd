...
if(file.exists("results/simulation_range_restriction.rds")){

  simulation <- read_rds("results/simulation_range_restriction.rds")
  ...
  simulation <-
    ...
    mutate(generated_data = future_pmap(.l = list(n, mean, sd),
                                        .f = generate_data,
                                        .progress = TRUE,
                                        .options = furrr_options(seed = TRUE))) |>

    # apply the analysis function to the generated data using the parameters relevant to analysis
    mutate(analysis_results = future_pmap(.l = list(generated_data),
                                          .f = analyse_data,
                                          .progress = TRUE,
                                          .options = furrr_options(seed = TRUE))) |>
  ...
  write_rds(x = simulation,
            file = "results/simulation_range_restriction.rds",
            compress = "gz")
