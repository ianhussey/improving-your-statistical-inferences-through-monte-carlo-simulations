...
if(file.exists("results/simulation_se_sd_1.rds")){

  simulation_1 <- read_rds("results/simulation_se_sd_1.rds")
  ...
  write_rds(x = simulation_1, file = "results/simulation_se_sd_1.rds", compress = "gz")
...
if(file.exists("results/simulation_se_sd_2.rds")){

  simulation_2 <- read_rds("results/simulation_se_sd_2.rds")
  ...
  write_rds(x = simulation_2, file = "results/simulation_se_sd_2.rds", compress = "gz")
...
if(file.exists("results/simulation_se_sd_3.rds")){

  simulation_3 <- read_rds("results/simulation_se_sd_3.rds")
  ...
  write_rds(x = simulation_3, file = "results/simulation_se_sd_3.rds", compress = "gz")
