...
The invention of the standardized shipping container, the Twenty-foot Equivalent Unit (TEU), had a massive impact on global trade. Because of their standardized shape, they can be loaded or unloaded at roughly 5000 tonnes per hour - thousands of times more efficiently. Sure, the robots and logistics systems are part of this improved efficiency, but much of the benefit comes from simply standardizing the inputs and inputs to follow a similar structure.
...
Ready to practice? 
Download and complete [the exercises for this chapter](https://raw.githubusercontent.com/ianhussey/improving-your-statistical-inferences-through-monte-carlo-simulations/main/exercises/6_analysis_functions_exercises.qmd){download="6_analysis_functions_exercises.qmd"}
:::
