...
simulation_summary <- simulation |>
  ...
  summarize(proportion_significant = mean(significant),
            average_mean_difference = mean(mean_diff),
...
- Modify each of the above expand grids to use skewnormal_from_m_sd_skew() before it rather than calculating manually after it. 
- The other simulation of heteroscedasticity should come first, its easier to implement.
