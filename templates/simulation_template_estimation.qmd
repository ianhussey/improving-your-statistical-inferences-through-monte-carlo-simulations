...
if(file.exists("results/simulation_template_estimation.rds")){

  simulation <- read_rds("results/simulation_template_estimation.rds")
  ...
  write_rds(x = simulation,
            file = "results/simulation_template_estimation.rds",
            compress = "gz")
